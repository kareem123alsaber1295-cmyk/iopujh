  ...
  return {
    ...
    seedancePrompts: [
      ...
      },
      {
        ...
        fullPrompt: `9:16 vertical, realistic iPhone-style footage. Female, 40s, glasses, comfortable sweater, sitting in a living room armchair with a houseplant visible behind her. Soft warm lamp light, slight golden tone, no overhead lighting. Camera on a tripod about 4 feet away, framed waist-up, very slow gentle zoom-in over the 30 seconds. She speaks warmly, unhurried: "I bought ${name} because my daughter sent me a link. I was skeptical — I've seen a lot of stuff in ${category} that doesn't deliver. But week two, I noticed ${benefit}. Now I order it on subscription. That's all I have to say." She sips from a mug halfway through. Glances off-camera once. Close-mic vocal, light room tone. Timing: 0–3s setup, 3–${len === "30 sec" ? "26" : len === "15 sec" ? "13" : "7"}s script with sip beat at midpoint. Avoid fake movements, glitches, robotic delivery, overproduced commercial feel, unrealistic product interaction, dramatic gestures, fast cuts.`,
